...
def run_benchmark(
    ...
    for n_ctx in seq_lens:
        ...
        triton_ms, triton_p95_ms, triton_throughput, triton_vram = _bench_fn(triton_fn, warmup, iters, device)
        ...
        pytorch_ms, pytorch_p95_ms, pytorch_throughput, pytorch_vram = _bench_fn(pytorch_fn, warmup, iters, device)
